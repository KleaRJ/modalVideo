      ...
      <LinearGradient colors={['#223DA2', '#4776C6']} style={mode === "portrait"? styles.navBg : styles.navBg2}>
        ...
        <View style={styles.linkcenter}>
          <ScrollView
            ...
            <View style={styles.linkcenter2}>
            <Text style={mode === "portrait" ? styles.links : styles.links2} onPress={() => Linking.openURL('maps://app?saddr=Cupertino&San+Francisco')}>About</Text>
            </View>
            <View style={styles.linkcenter2}>
            <Text style={mode === "portrait" ? styles.links : styles.links2} onPress={() => Linking.openURL('maps://app?saddr=Cupertino&San+Francisco')}>Portfolio</Text>
            </View>
            <View style={styles.linkcenter2}>
